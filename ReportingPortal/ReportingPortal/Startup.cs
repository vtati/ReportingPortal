...
using ReportingPortal.Authorization;
using ReportingPortal.Helpers;
using ReportingPortal.ViewModels;
...
namespace ReportingPortal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("ReportingPortal"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "ReportingPortal API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ILogger<Startup> logger, IDatabaseInitializer databaseInitializer)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ReportingPortal API V1");
            });
